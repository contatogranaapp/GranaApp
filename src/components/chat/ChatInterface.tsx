...
export function ChatInterface({ profile, summary, goals, recentTransactions, isPro }: Props) {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <header className="flex items-center justify-between px-8 py-4 border-b border-white/[0.07] bg-[#0C0C0F]/90 backdrop-blur-md sticky top-0 z-10">
      ...
      {/* Input */}
      <div className="px-8 pb-6 border-t border-white/[0.06] pt-3">
