...
export default function TransacoesPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <header className="flex items-center justify-between px-8 py-5 border-b border-white/[0.07] sticky top-0 bg-[#0C0C0F]/90 backdrop-blur-md z-10">
        <h1 className="text-base font-medium">Transações</h1>
                ...
                <div key={tx.id} className="group flex items-center gap-3 px-5 py-3.5 border-b border-white/[0.03] last:border-0 hover:bg-white/[0.02] transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      {tx.notes && (
                        <span className="text-[10px] text-white/20 truncate max-w-[120px]">{tx.notes}</span>
                      )}
                    </div>
                  </div>
