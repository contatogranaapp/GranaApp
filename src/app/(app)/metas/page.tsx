...
export default function MetasPage() {
  ...
  const s = {
    ...
    header: {
      ...
      padding: 'clamp(16px, 4vw, 20px) clamp(16px, 5vw, 32px)', borderBottom: '1px solid rgba(255,255,255,0.07)',
  ...
  return (
    <div style={s.page}>
      ...
      <header style={s.header}>
        <h1 style={{ fontSize: 'clamp(14px, 4vw, 15px)', fontWeight: 500, color: '#F0EFE8', margin: 0 }}>Metas</h1>
